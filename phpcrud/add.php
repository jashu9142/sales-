                      ...
                      <div class="col-lg-6">
                        ...
                        <form role="form" method="post" action="transac.php?action=add">
                            ...
                            <div class="form-group">
                              <input class="form-control" placeholder="estimate_no" name="estimate_no">
                            </div>
                            <div class="form-group">
                              <input class="form-control" placeholder="reference_no" name="reference_no">
                            </div> 
                            <div class="form-group">
                              <input class="form-control" placeholder="customer_name" name="customer_name">
                            </div> 
                            <div class="form-group">
